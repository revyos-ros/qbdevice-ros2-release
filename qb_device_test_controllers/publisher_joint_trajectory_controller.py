...
class PublisherJointTrajectory(Node):
    def __init__(self):
        ...
        self.declare_parameter("namespace", "qbhand1")
        self.declare_parameter("prefix", "qbhand1")
        ...
        for i in range(len(self.joints)):
            self.joints[i]= prefix + self.joints[i]
        ...
        for name in goal_names:
            ...
            if one_ok:
                point.time_from_start = Duration(sec=wait_sec_between_publish)
        ...
        publish_topic = "/" + namespace + "/" + prefix + controller_name + "/" + "joint_trajectory"
