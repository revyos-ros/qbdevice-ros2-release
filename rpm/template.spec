...
Name:           ros-humble-qb-device-msgs
Version:        4.1.3
Release:        1%{?dist}%{?release_suffix}
Summary:        ROS qb_device_msgs package

License:        BSD 3-Clause
URL:            http://wiki.ros.org/qb_device_msgs
...
%description
This package contains the device-independent custom ROS messages for qbrobotics®
devices.
